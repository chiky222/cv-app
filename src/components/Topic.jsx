        ...
        <div className='topic-gral'>
            <div className='topic-container'>
                <Routes>                  
                    ...
                    <Route path='/referencias' element={ <Referencias topic={topics} /> } />
            ...
            <div className='download-buttons'>
              <button className='boton-up'>
                <a href={pdf} target="_blank" rel="noopener noreferrer" download="CV pdf - Cristian Ferrer">Descargar PDF</a>
              </button>
              <button className='boton-up'>
                <a href={png} target="_blank" rel="noopener noreferrer" download="CV png - Cristian Ferrer">Descargar PNG</a>
              </button>
            </div>
            <div className='end-container'>
              <button className='boton-up' onClick={onClickUp}>Ir Arriba</button>
              <p className='text-end'>Creado por Cris Ferrer.</p>
            </div>
        </div>
    </HashRouter>
  )
